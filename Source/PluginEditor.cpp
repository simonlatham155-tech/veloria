...
void VeloriaAudioProcessorEditor::resized()
{
    ...
    ampWalk.setBounds(32,108,76,242);timeWalk.setBounds(132,108,76,242);ampMirror.setBounds(232,108,76,242);timeMirror.setBounds(332,108,76,242);
    ...
    seed.setBounds(1150,160,96,110);fieldStatus.setBounds(1248,184,120,35);presetNameEditor.setBounds(1146,310,210,29);savePresetButton.setBounds(1146,350,64,29);renamePresetButton.setBounds(1216,350,66,29);deletePresetButton.setBounds(1288,350,68,29);presetStatus.setBounds(1146,392,210,50);voiceStatus.setBounds(1146,548,210,22);level.setBounds(1172,686,156,150);footerStatus.setBounds(415,872,570,14);
}
